...
next-prompt delivery when present. For an interim checkpoint, report the
background-task count without reproducing task descriptions or commands.
Identify `lastForcedPublishAt` as an audited
